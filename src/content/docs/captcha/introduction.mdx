...
- 📖 [View reCAPTCHA Examples](/docs/captcha/examples/recaptcha)

### hCaptcha
- ✅ Checkbox (normal/compact)
- ✅ Invisible
- ✅ Programmatic execution
- 📖 [View hCaptcha Examples](/docs/captcha/examples/hcaptcha)

### Cloudflare Turnstile
- ✅ Managed (normal/compact/flexible)
- ✅ Non-interactive
- ✅ Invisible (dashboard configured)
- 📖 [View Turnstile Examples](/docs/captcha/examples/turnstile)

### Friendly Captcha
- ✅ Automatic puzzle solving
- ✅ Privacy-focused (GDPR compliant)
- ✅ Configurable start modes (auto/focus/none)
- 📖 [View Friendly Captcha Examples](/docs/captcha/examples/friendly-captcha)
