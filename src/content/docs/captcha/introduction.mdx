...
- 📖 [View the reCAPTCHA Implementation Guide](/docs/captcha/implementation-guides/recaptcha)

### hCaptcha
- ✅ Checkbox (normal/compact)
- ✅ Invisible
- ✅ Programmatic execution
- 📖 [View the hCaptcha Implementation Guide](/docs/captcha/implementation-guides/hcaptcha)

### Cloudflare Turnstile
- ✅ Managed (normal/compact/flexible)
- ✅ Non-interactive
- ✅ Invisible (dashboard configured)
- 📖 [View the Turnstile Implementation Guide](/docs/captcha/implementation-guides/turnstile)

### Friendly Captcha
- ✅ Automatic puzzle solving
- ✅ Privacy-focused (GDPR compliant)
- ✅ Configurable start modes (auto/focus/none)
- 📖 [View the Friendly Captcha Implementation Guide](/docs/captcha/implementation-guides/friendly-captcha)
