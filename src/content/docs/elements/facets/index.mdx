...
3. **Configure the UI components:**
   ...
   - • Set the required props (see [Configuration](/facets/configuration) for details)

4. **Setup the client script to subscribe to events:**

- • Use the observer to subscribe to channels when events occur (see [Configuration](/facets/configuration) for details)
