...
The FacetSearchFilter is an optional component and should be used nested inside of the [FacetSearch](#facetsearch-props) component. This component should consume the slot `elements-facets-filter-bar` when used.
This component enables character filtering allowing users to filter based on the first character of options.
