...
2. **[Page Types](./page-types)** - Configure page type tracking for richer analytics
3. **[Event Tracking](./tracking)** - Track user interactions with HTML attributes
4. **[JavaScript API](./advanced/javascript-api)** - Programmatic tracking for advanced scenarios
