...
For applications using a bundler, you can install and initialise Insights programmatically:
...
This approach is useful for single-page applications where you need more control over initialisation timing.
...
2. **[JavaScript API](./advanced/javascript-api)** - Programmatic tracking for advanced scenarios
