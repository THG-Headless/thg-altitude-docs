...
<Aside type="note">
    i18n is currently only supported in multi-tenancy mode.
</Aside>
...
You **must** have the 404.astro page at outside the [locale] directory, or custom 404 pages will not work. The 404 page will be served for any request that does not match a route in the [locale] directory.
