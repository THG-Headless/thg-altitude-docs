...
import SummaryAccordion from '@components/docs/browser-components/accordion/SummaryAccordion.html';
import NamedSummaryAccordion from '@components/docs/browser-components/accordion/NamedSummaryAccordion.html';
...
<ShowComponent filePath="./src/components/docs/browser-components/accordion/SummaryAccordion.html">
  <SummaryAccordion />
</ShowComponent>
...
<ShowComponent filePath="./src/components/docs/browser-components/accordion/NamedSummaryAccordion.html">
