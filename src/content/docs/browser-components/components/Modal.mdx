...
import BasicModal from '@components/docs/browser-components/modals/BasicModal.html';
import NoBackdropModal from '@components/docs/browser-components/modals/NoBackdropModal.html';
import HeroModal from '@components/docs/browser-components/modals/HeroModal.html';
import ComplexModal from '@components/docs/browser-components/modals/ComplexModal.html';
import BackdropCloseModal from '@components/docs/browser-components/modals/BackdropCloseModal.html';
import FullScreenModal from '@components/docs/browser-components/modals/FullScreenModal.html';
import NoEntranceModal from '@components/docs/browser-components/modals/NoEntrance.html';
