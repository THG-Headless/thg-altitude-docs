...
import BasicModal from "@components/docs/browser-components/v0.2.0/modals/BasicModal.html";
import NoBackdropModal from "@components/docs/browser-components/v0.2.0/modals/NoBackdropModal.html";
import HeroModal from "@components/docs/browser-components/v0.2.0/modals/HeroModal.html";
import ComplexModal from "@components/docs/browser-components/v0.2.0/modals/ComplexModal.html";
import BackdropCloseModal from "@components/docs/browser-components/v0.2.0/modals/BackdropCloseModal.html";
import FullScreenModal from "@components/docs/browser-components/v0.2.0/modals/FullScreenModal.html";
import NoEntranceModal from "@components/docs/browser-components/v0.2.0/modals/NoEntrance.html";
