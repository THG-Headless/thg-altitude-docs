---
title: Introduction
description: Introduction to the Browser Component Library
order: 1
---
...
The Browser Component Library provides two key features. The first is the Altitude Design System, an extensible approach to site theming built to let you design without constraints, all while helping you maintain consistent styling that can be entirely managed from your main CSS file. Whether you are building a site for one or a hundred tenants, the Altitude Design System is built to work seamlessly.

The Altitude Design System ships with defaults for the following, but as it is just CSS, it's all yours to customise and expand on.
...
_Detailed documentation on the design system is available in the [Altitude Design System](/docs/browser-components/v0.2.0/design/principles/) chapters of this documentation._
...
Ready to get started? Refer to the [installation guide](/docs/browser-components/v0.2.0/setup/installation) to add the Browser Components library to your project.
