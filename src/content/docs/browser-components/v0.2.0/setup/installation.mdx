...
import DemoComponent from "@components/docs/browser-components/v0.2.0/doc-helpers/DemoComponent.html";

# Installation

## Prerequisites

> **⚠️ IMPORTANT:** This package requires **Tailwind CSS v4**. The components use modern CSS features like OKLCH colors and relative color syntax that are only available in Tailwind v4 and will not function correctly with earlier versions.

To verify your Tailwind version:
```bash
...
<ComponentPreview filePath="src/components/docs/browser-components/v0.2.0/doc-helpers/DemoComponent.html">
  <DemoComponent />
</ComponentPreview>
