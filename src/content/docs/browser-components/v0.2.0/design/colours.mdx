...
import SiteColours from "@components/docs/browser-components/v0.2.0/doc-helpers/SiteColours.astro";
import ColorScheme from "@components/docs/browser-components/v0.2.0/doc-helpers/Colorscheme.astro";
