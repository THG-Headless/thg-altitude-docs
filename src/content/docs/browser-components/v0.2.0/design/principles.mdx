...
So first things first, what is the _Altitude Design System_, why did we implement it across the Browser Components Library, and why should you consider adopting it for your entire site?
...
- Through the use of the [skins system](/docs/browser-components/v0.2.0/design/skins) styles are referenced semantically.
- This means that when editing a component's skin:
  - It is easy to know what it will affect from its name. (i.e modifying `skin-form` will modify all forms on the site, assuming that they use the `skin-form` class)
  - There is a low risk of accidentally changing an unrelated component
