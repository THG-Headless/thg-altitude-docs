...
| Key              | Required | Default | Type          | Examples                          | Description                                                                                     |
| ---------------- | -------- | ------- | ------------- | --------------------------------- | ----------------------------------------------------------------------------------------------- |
| path             | Yes      |         | String        | /health <br/> /healthcheck        | The path for the health check endpoint on your worker                                           |
...
| headers          | No       |         | Array[String] | ["X-Altitude-Instance: mysite"]   | Custom headers to include in the health check request, in the format `Header-Name: Header-Value`|
