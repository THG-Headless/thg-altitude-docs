...
- **Simplified setup**: The i18n key is no longer required for applications that do not need localisation.
...
- **Cookie routing** has been removed. This feature was deprecated because it was only used by the [account](https://github.com/THG-Headless/account) repository, which has since migrated to resolving locales directly from the `Host` request header.
